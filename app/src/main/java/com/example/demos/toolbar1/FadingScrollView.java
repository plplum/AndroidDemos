...
public class FadingScrollView extends ScrollView {
    ...
    private static String TAG = FadingScrollView.class.getSimpleName();
    ...
    public FadingScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
