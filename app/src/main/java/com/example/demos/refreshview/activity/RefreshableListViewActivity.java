...
import com.example.demos.refreshview.view.PullToRefreshListView;

public class RefreshableListViewActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPullListView = (PullToRefreshListView) findViewById(R.id.refresh_list);
        
        mPullListView.setPullLoadEnabled(false);
        mPullListView.setScrollLoadEnabled(true);
        
        mAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, mListItems);
        mListView =  mPullListView.getRefreshableView();//(ListView)findViewById(R.id.list_view);
