package com.example.demos.horizontalmenu.activity;
...
import com.example.demos.horizontalmenu.NewsFragment;
import com.example.demos.horizontalmenu.view.HorizontalMenu;

public class MainActivity extends FragmentActivity {
    private HorizontalMenu tabs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabs = (HorizontalMenu) findViewById(R.id.category_strip);
