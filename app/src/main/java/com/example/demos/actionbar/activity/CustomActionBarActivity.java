...
public class CustomActionBarActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_searchview1);
		initActionbar();
		names = loadData();
	...
	public void setSearchViewBackground(SearchView searchView) {
		try {
			...
			mView.setBackgroundDrawable(getResources().getDrawable(R.drawable.action_search));
			...
			mCursorDrawableRes.set(mQueryTextView.get(searchView), R.drawable.action_search);// 注意第一个参数持有这个属性(mQueryTextView)的对象(mSearchView)
