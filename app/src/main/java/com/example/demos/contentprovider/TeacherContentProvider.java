...
import static com.example.demos.contentprovider.ContentData.UserTableData.TEACHER;
import static com.example.demos.contentprovider.ContentData.UserTableData.TEACHERS;
import static com.example.demos.contentprovider.ContentData.UserTableData.CONTENT_TYPE;
import static com.example.demos.contentprovider.ContentData.UserTableData.CONTENT_TYPE_ITME;
...
public class TeacherContentProvider extends ContentProvider {
	...
	public boolean onCreate() {
		...
		uriMatcher = ContentData.UserTableData.uriMatcher;
		return true;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		System.out.println("uri= "+ uri + "matcher = "+ matcher);
		switch (matcher) {
		case TEACHERS:
